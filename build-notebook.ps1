...
.SYNOPSIS
  ...
  invalid fields, and moves to _includes/notebooks. If a "<notebook>_dark.ipynb"
  sibling exists next to the main notebook, builds and moves that too --
  the light/dark notebook-embed convention used by
