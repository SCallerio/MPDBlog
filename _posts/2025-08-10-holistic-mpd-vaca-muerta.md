...
<img src="{{ site.baseurl }}/images/drain_frac_stages_growth_YOY_plus_areaplot_light.svg"
     data-light-src="{{ site.baseurl }}/images/drain_frac_stages_growth_YOY_plus_areaplot_light.svg"
     data-dark-src="{{ site.baseurl }}/images/drain_frac_stages_growth_YOY_plus_areaplot_dark.svg"
...
*<small class="fig-caption">Fig. 1 &mdash; Year-on-Year mean reported drilled horizontal length and total frac stages per well, for Argentina unconventional Wells<br />
...
<img src="{{ site.baseurl }}/images/quintuco_vaca_muerta_drilling_window_light.png"
     data-light-src="{{ site.baseurl }}/images/quintuco_vaca_muerta_drilling_window_light.png"
     data-dark-src="{{ site.baseurl }}/images/quintuco_vaca_muerta_drilling_window_dark.png"
     alt="Production section mud weight window and simplified wellbore schematic"
     style="display: block; margin-left: auto; margin-right: auto; width: 100%; height: auto;">


*<small class="fig-caption">Fig. 2 &mdash; Production section mud weight window (left) and simplified wellbore schematic (right), after Frydman et al. (2018) (Callerio et al., 2025)<br /></small>*
...
<img src="{{ site.baseurl }}/images/Connection_SBP_ESD_Trend_light.svg"
     data-light-src="{{ site.baseurl }}/images/Connection_SBP_ESD_Trend_light.svg"
     data-dark-src="{{ site.baseurl }}/images/Connection_SBP_ESD_Trend_dark.svg"
     alt="Connection SBP and ESD Trend"
     style="display: block; margin-left: auto; margin-right: auto; width: 100%; height: auto;">
*<small class="fig-caption">Fig. 3 &mdash; Connections (CNX) Surface Back-Pressure (SBP), Equivalent Static Density (ESD), and maximum Connection Gas Flow-Rate for Pressure Trapping MPD Application (Callerio et al., 2025). 
...
<img src="{{ site.baseurl }}/images/rollover_depth_case_light.png"
     data-light-src="{{ site.baseurl }}/images/rollover_depth_case_light.png"
     data-dark-src="{{ site.baseurl }}/images/rollover_depth_case_dark.png"
     alt="Wellbore and Kill Mud Rollover"
     style="display: block; margin-left: auto; margin-right: auto; width: 100%; height: auto;">
*<small class="fig-caption">Fig. 4 &mdash; Schematic of wellbore and rollover kill-mud; the left-most case corresponds to the conventional case, 
...
<img src="{{ site.baseurl }}/images/TvsD_Tripping_light.svg"
     data-light-src="{{ site.baseurl }}/images/TvsD_Tripping_light.svg"
     data-dark-src="{{ site.baseurl }}/images/TvsD_Tripping_dark.svg"
     alt="Tripping Time for each Rollover Depth"
     style="display: block; margin-left: auto; margin-right: auto; width: 100%; height: auto;">
*<small class="fig-caption">Fig. 5 &mdash; Average tripping time for each rollover depth case (Callerio et al., 2025). The conventional case requires a full wellbore displacement, 
...
<img src="{{ site.baseurl }}/images/KM_Volume_Comparison_Tripping_Rollover_Time_light.svg"
     data-light-src="{{ site.baseurl }}/images/KM_Volume_Comparison_Tripping_Rollover_Time_light.svg"
     data-dark-src="{{ site.baseurl }}/images/KM_Volume_Comparison_Tripping_Rollover_Time_dark.svg"
...
*<small class="fig-caption">Fig. 6 &mdash; Tripping and Rollover Time comparison for the different drilling methods (left), and Kill Mud Volume comparison (right) (Callerio et al., 2025). As observed, the
...
<img src="{{ site.baseurl }}/images/cementacion_both_light.svg"
     data-light-src="{{ site.baseurl }}/images/cementacion_both_light.svg"
     data-dark-src="{{ site.baseurl }}/images/cementacion_both_dark.svg"
     alt="Conventional and MPC Operating Windows"
     style="display: block; margin-left: auto; margin-right: auto; width: 90%; height: auto;">

*<small class="fig-caption">Fig. 7 &mdash; Conventional cementing job (top), and MPC job (bottom) operating windows (Callerio et al., 2025).
