...
{% include image.html url="./img/bacon_downhole_volume.svg?sanitize=true" description="Downhole Influx Volume" %}
...
|                                                                                                                                                                                                                              ![MPD Dynamic Well Control](/img/bacon_2016_RDFM_MPD_Dynamic_Well_Control_for_IME.png)                                                                                                                                                                                                                              |
|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
